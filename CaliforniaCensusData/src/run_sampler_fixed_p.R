...
opt_parser <- add_argument(opt_parser, arg = "--graph-sparsity", type = "double", default = 0.5,
                           help = "Value of 'graph-sparsity' parameter, fixed in [0,1]")
...
params <- sprintf(params_template, H, extra_args$rho, extra_args$graph_sparsity)
