...
#PBS -N BD_Scenario1-compute_WAIC
#PBS -o /u/gianella/log/BD_Scenario1-compute_WAIC.out
#PBS -e /u/gianella/log/BD_Scenario1-compute_WAIC.err
...
in-apptainer cook exec simulation_study:compute_WAIC &> log/compute_WAIC.log
