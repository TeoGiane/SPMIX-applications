...
#PBS -N BD_Scenario1-compute_mean_L1_distances
#PBS -o /u/gianella/log/BD_Scenario1-compute_mean_L1_distances.out
#PBS -e /u/gianella/log/BD_Scenario1-compute_mean_L1_distances.err
...
in-apptainer cook exec simulation_study:compute_mean_L1_distances &> log/compute_mean_L1_distances.log
